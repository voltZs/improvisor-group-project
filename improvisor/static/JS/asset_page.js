var asset; // This is set in the callback function of the fetchAsset ajax call
var assetTags = [];
...
function fetchAsset(id) {
    ...
    $.ajax({
        ...
        success: function (data) {
            ...
            console.log(asset);
            showAsset(asset);
            fetchAssetCallback(asset);
        }
    });
}

// Callback to get the asset object return from the ajax query
function fetchAssetCallback(response) {
    asset = response;
}
